...
type AuthenticationRepository interface {
	...
	GetAuthorizationURL(ctx context.Context, state, redirectURI string) (string, error)
	ExchangeCode(ctx context.Context, code, redirectURI string) (*domain.Token, error)
